 ...
 * @author edin1
 */
public class Modificar_GuardarVentas extends javax.swing.JInternalFrame {

    /**
     * Creates new form Modificar_Guardar
     */
    public Modificar_GuardarVentas() {
        initComponents();
    }
void limpiar(){
    jtflCaja.setText("");
...
if(VistaAdmin.banderaGuardarActualizar){
    ...
    controlador.Actualizar(jtflcodigo.getText().trim(),jtflNombre.getText().trim(),jtflCaja.getText().trim() ,jtflVentas.getText().trim(),jtflGenero.getText().trim(), jPassword.getText(), VistaAdmin.nu);
}
Escritorio.remove(this);  
VistaAdmin.banderaboton=true;
VistaAdmin.banderaGuardarActualizar = true;
limpiar();
